...
{
    // These are built with no vehicle attached, so only vehicle independent indicators belong
    // here. The vehicle's own row comes from FirmwarePlugin::toolIndicators.
